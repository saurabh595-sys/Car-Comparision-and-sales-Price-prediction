...
namespace WebApplication1ML.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\saurabh\Desktop\priceprediction.csv";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var dataProcessPipeline = mlContext.Transforms.Categorical.OneHotEncoding(new[] { new InputOutputColumnPair("fuel_type", "fuel_type") })
                                      .Append(mlContext.Transforms.Text.FeaturizeText("name_tf", "name"))
                                      .Append(mlContext.Transforms.Text.FeaturizeText("company_tf", "company"))
                                      .Append(mlContext.Transforms.Concatenate("Features", new[] { "fuel_type", "name_tf", "company_tf", "year", "kms_driven" }));
